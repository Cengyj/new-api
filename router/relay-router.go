...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	{
		...
		playgroundRouter.POST("/images/generations", controller.PlaygroundFor(types.RelayFormatOpenAIImage))
		playgroundRouter.POST("/images/edits", controller.PlaygroundFor(types.RelayFormatOpenAIImage))
