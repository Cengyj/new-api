...
// Initialize generation controllers early so queued tasks keep running even
// when user navigates away from the image/video pages.
  ...
  return (
    <SetupCheck>
      <Routes>
        ...
        />
        <Route
          path='/console/ai-creation/image'
          element={
            <PrivateRoute>
              <Suspense fallback={<Loading></Loading>} key={location.pathname}>
                <AiImage />
        ...
        />
        <Route
          path='/console/ai-creation/video'
          element={
            <PrivateRoute>
              <Suspense fallback={<Loading></Loading>} key={location.pathname}>
                <AiVideo />
