...
const SiderBar = ({ onNavigate = () => {} }) => {
  ...
  const chatMenuItems = useMemo(() => {
    const items = [
      {
        text: t('对话'),
        itemKey: 'aiCreationChat',
        to: '/console/ai-creation/chat',
      },
      {
        text: t('生图'),
        itemKey: 'aiCreationImage',
        to: '/console/ai-creation/image',
      },
      {
        text: t('视频'),
        itemKey: 'aiCreationVideo',
        to: '/console/ai-creation/video',
      },
      {
        text: t('操练场'),
        itemKey: 'playground',
  ...
  useEffect(() => {
    ...
    if (!matchingKey && currentPath.startsWith('/console/ai-creation')) {
      const creationTab = currentPath.split('/').pop();
      if (creationTab === 'image') {
        matchingKey = 'aiCreationImage';
      } else if (creationTab === 'video') {
        matchingKey = 'aiCreationVideo';
      } else {
        matchingKey = 'aiCreationChat';
      }
    }
